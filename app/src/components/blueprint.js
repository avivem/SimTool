...
class BlueprintPopUp extends Component{
 ...
 //       var upper = parseInt(this.state.upperAmount);
        ...
        if(max >= loc){
            this.props.addSpec(specName, dist, resource, loc, scale, max, init, capacity, value);
            this.closeSpecPopup();
            this.state.value = -1;
    ...
    render(){
        ...
        return (
            <Popup open={this.props.openSpecPopup} closeOnDocumentClick = {true} onClose={this.closeSpecPopup} >
